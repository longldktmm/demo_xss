...
/******/ 	var hotCurrentHash = "891b0be4610a711dd35d";
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createMarkup(messages) {
	    return { __html: "<div><form action='' method='GET'><input id='query' name='query' value='Enter query here...' onfocus='this.value=" + "\"\"" + "'></input><input id='button' type='submit' value='Search'></input></form></div>" + messages.map(function (message) {
	...
	var App = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        fetch("/api/get/mess").then(function (res) {
	            return res.json();
	        }).then(function (messages) {
	            return _this.setState({ messages: messages });
	        });
	    },
	    upMessage: function upMessage() {
	        ...
	        if (newMessage) fetch("/api/post/mess", {
	            method: "POST",
	            headers: new Headers({
	    ...
	    render: function render() {
	        ...
	        return React.createElement("div", null, React.createElement("h2", null, "React Message Board"), React.createElement("div", null, React.createElement("textarea", { value: newMessage,
	            ...
	            rows: "3" })), React.createElement("div", null, React.createElement("button", { onClick: function onClick() {
	                return _this.upMessage();
	            } }, "Đăng bài")), React.createElement("div", { dangerouslySetInnerHTML: createMarkup(messages) }));
	    }
	});
